...
function RegistroGrupal() {
  ...
  useEffect(() => {
    const fetchDocument = async () => {
      try {
        const docRef = doc(db, 'asistentes', 'grupo-id'); // Reemplaza 'grupo-id' con el ID adecuado
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await setDoc(doc(db, 'asistentes', 'grupo-id'), formData, { merge: true }); // Reemplaza 'grupo-id' con el ID adecuado
    ...
    <div className="containercititito">
      ...
      <form className="registration-form" onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input className="input" type="text" name="nombreResponsable" value={formData.nombreResponsable} onChange={handleChange} required />
        </div>
        <div className="form-group">
