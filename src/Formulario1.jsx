...
function Formulario1() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const tipoRegistro = e.target.elements.tipoRegistro.value;
        ...
        <div className="containercititito">
            ...
            <form className="registration-form" onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    <input placeholder="Tu dirección de correo electrónico" className="input" type="email" name="email" required/>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    ...
                    <p className="description">
                        • Individual: una sola persona.<br/>
                        • Familiar: los participantes tienen algún parentesco: padres, hijos, tíos, sobrinos, etc.<br/>
                        • Grupo Escolar: todos los participantes pertenecen a una escuela y son acompañados
                        de un responsable.<br/>
                        • Grupal Abierto: Es un grupo diverso con poca o ninguna relación familiar y los
                        menores vienen acompañados con un tutor.<br/>
                    </p>
                ...
                <div>
                    <p className="description">
                        ...
                        a) Registrar su asistencia al evento en comento;<br/><br/>
                        b) generar listas de asistencias y validación de las mismas;<br/><br/>
                        c) emisión de constancia de participación o asistencia;<br/><br/>
                        d) establecer comunicación para dar seguimiento o aclaración de dudas sobre sus datos,
                        notificación de cancelación o cambio de horario, fecha; y<br/><br/>
                        e) generar estadísticas para informes obligatorios.<br/><br/>
                        De manera adicional, utilizaremos su información personal para las siguientes finalidades
                        que no son necesarias, pero que nos permiten y facilitan brindarle una mejor atención:<br/><br/>
                        a) envío de material de exposición o apoyo; e,<br/><br/>
                        b) invitaciones a futuros eventos.<br/><br/>
                        En caso de que no desee que sus datos personales sean tratados para las finalidades
                        adicionales, usted puede manifestarlo en el correo electrónico coepes.chiapas@gmail.com<br/><br/>
                        ...
                        competente, debidamente fundados y motivados.<br/><br/>
                    ...
                    <p className="description"><b>Para continuar con su registro debe aceptar los términos y condiciones del registro para participar en el evento</b></p><br/><br/>
                    <p className="description">
